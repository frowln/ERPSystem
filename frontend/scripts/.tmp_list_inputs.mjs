...
const placeholders = await page.locator('input').evaluateAll((nodes) => nodes.map((n) => n.getAttribute('placeholder') || ''));
console.log('INPUT_COUNT', placeholders.length);
for (const p of placeholders) console.log('PLACEHOLDER', p);
