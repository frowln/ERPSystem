...
public class SickLeaveController {
    ...
    @GetMapping
    @Operation(summary = "List all sick leaves with pagination")
    public ResponseEntity<ApiResponse<PageResponse<SickLeaveResponse>>> list(
            @PageableDefault(size = 20, sort = "startDate", direction = Sort.Direction.DESC) Pageable pageable) {
        Page<SickLeaveResponse> page = sickLeaveService.listSickLeaves(pageable);
